...
public class CardSprite extends TiledSprite implements  IActionOnSceneListener, IClickableSprite{
	...
	public static final int TILEDSPRITE_SIZE = CardSprite.VERTEX_SIZE * CardSprite.VERTICES_PER_TILEDSPRITE;
	 */
